...
module.exports = CoreObject.extend({
  ...
  rebuild: function() {
    ...
    if (isRebuild) {
      ...
      diffs = this.entries.map(function(entry){
        // entries right now is a string, but could be a broccoli node
        return {
          name: entry,
          hash: null,
          graph: null
    ...
    // TODO: much cleanup yo, stef is making a mess...
    // TODO: extract to shared function, because this is used in resolve(
