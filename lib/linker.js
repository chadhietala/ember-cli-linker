...
module.exports = CoreObject.extend({
   ...
   */
  hashGraphs: function(descriptors) {
    var graphHashes = {};
  ...
  diffGraph: function() {
    ...
    var incomingHashes = this.hashGraphs(AllDependencies.getDescriptors());
  ...
  rebuild: function() {
    ...
    if (this.initialBuild) {
      this.graphHashes = this.hashGraphs(this.orderedDescriptors);
